	...
	<form id="customReportInput">
		<div id="custom-report-input">
			<div class="input-set" id="selectDiv">
                ...
                <input type="radio" {formname key=REPORT_RESULTS} value="{Report_ResultSelection::COUNT}"
                       id="results_training"/>
                <label for="results_training">{translate key=Trainings}</label>
			</div>
			...
			<div class="input-set select-toggle" id="aggregateDiv" style="display:none;">
				...
				<label for="groupby_none">{translate key=None2}</label>
				...
				<input type="radio" {formname key=REPORT_GROUPBY} value="{Report_GroupBy::USER}"
					   id="groupby_user"/>
                <label for="groupby_user" id="groupByUserLabel">{translate key=User} > <span id="zeroResUsersContainer"><input type="checkbox" id="zeroResUsers" name="zeroResUsers" />&nbsp; <label for="zeroResUsers">Μόνο χρήστες χωρίς κρατήσεις</label></span></label>
            ...
            <div class="input-set select-toggle" id="emptyDiv">
                ...
                <label for="groupby_user_training" id="groupByUserLabel_training">{translate key=User}
            </div>
			<div class="input-set">
			...
			<div class="input-set">
				...
				<select class="textbox" style="display:none" {formname key=RESOURCE_ID}>
