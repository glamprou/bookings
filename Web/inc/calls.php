...
if (isset($_POST['acceptCall'])){
	...
	sendOrSchedule("CallAcceptedEmail",$user,$calleruser,TRUE);
...
if (isset($_POST['declineCall'])){
	...
	$user=$userrep->LoadById($row->callee_user_id);
	$calleruser=$userrep->LoadById($row->caller_user_id);
	sendOrSchedule("CallDeclinedEmail",$user,$calleruser,FALSE);
	...
	sendOrSchedule("CallDeclinedEmail",$calleruser,$user,FALSE, $morethanthreematches);
	$db=ServiceLocator::GetDatabase();
	$db->Connection->Connect();
