...
if(isset($_POST['ajaxize'])){
	if(isset($_POST['updateTour'])){
		 ...
		 $sdate=changeDate($_POST['date_start']);
		 $edate=changeDate($_POST['date_end']);
		 $tourid=$_POST['tourid'];
		 mysql_query("update r_tours set tour_name='$tname', tour_date='$sdate', tour_date_fin='$edate' where tour_id=$tourid ");
	}
	?>
        ...
        <div style="background-color:#FFFFFF">
            <div id="addResourceResults" class="error" style="display:none;"></div>
                <table>
                    ...
                    <tr>
                        <td  colspan="2" id="foundtours" style="display:none"></td>
                    </tr>
                </table>
            </div>
        </div>
                ...
                <form id="insertTourForm" action="" method="">
                    <table>
                        ...
                        <tr>
                            ...
                            <?php
                                $i=0;
                                $tr=mysql_query("select distinct r_tours.tour_id,r_tours.tour_name from r_tours inner join r_tours_participants on r_tours.tour_id=r_tours_participants.tour_id where r_tours_participants.countedToRank=-1 order by r_tours.tour_date asc");
        ...
        $(document).ready(function(){
            ...
            $('#newtourform').submit(function(){
                ...
                $.ajax({
                  ...
                  data: { tourname: $('#tournameid').val(), tourdate: $('#datepicker_start').val(), tourdateend: $('#datepicker_end').val()}
                }).done(function( msg ) {
                    if ($(".success")[0]){
					   // Do something here if class exists
					    $('.success').remove();
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Η εισαγωγή του τουρνουά '+$('#tournameid').val()+' έγινε με επιτυχία! Μπορείτε να προχωρήσετε στην εισαγωγή αποτελεσμάτων.</div>');
					}
					else{
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Η εισαγωγή του τουρνουά '+$('#tournameid').val()+' έγινε με επιτυχία! Μπορείτε να προχωρήσετε στην εισαγωγή αποτελεσμάτων.</div>');
					}
           ...
           /* $('#insertTourForm').submit(function(event){
            ...
            $('#selTourForEdit').change(function(){
                ...
                $('#foundtours').load("editToursOnly.php",{tourid:$(this).val()});
                ...
                $.ajax({
                  ...
                  data: { blocking: "ok", date:  $('#datepicker').val()}
                    ...
                    if ($(".success")[0]){
					   // Do something here if class exists
					    $('.success').remove();
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Οι προσκλήσεις θα μπλοκαριστούν στις '+$('#datepicker').val()+'. Προσοχή! Όλες οι μη ολοκληρωμένες προσκλήσεις θα ακυρωθούν στις '+$('#datepicker').val()+'!</div>');
					}
					else{
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Οι προσκλήσεις θα μπλοκαριστούν στις '+$('#datepicker').val()+'. Προσοχή! Όλες οι μη ολοκληρωμένες προσκλήσεις θα ακυρωθούν στις '+$('#datepicker').val()+'!</div>');
					}
                ...
                $.ajax({
                  ...
                  data: { unblocking: "ok"}
                    ...
                    if ($(".success")[0]){
					   // Do something here if class exists
					    $('.success').remove();
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Η διαδικασία των προσκλήσεων είναι πλέον ενεργή!</div>');
					}
					else{
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Η διαδικασία των προσκλήσεων είναι πλέον ενεργή!</div>');
					}
                ...
                $.ajax({
                  ...
                  data: { updateblock: "ok", updateblockdate:  $('#datepicker').val()}
                  	...
                  	if ($(".success")[0]){
					   // Do something here if class exists
					    $('.success').remove();
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Η ημερομηνία ενημερώθηκε. Οι προσκλήσεις θα μπλοκαριστούν στις '+$('#datepicker').val()+'. Προσοχή! Όλες οι μη ολοκληρωμένες προσκλήσεις θα ακυρωθούν στις '+$('#datepicker').val()+'!</div>');
					}
					else{
					    $('#content').prepend('<div class="success" style="" id="profileUpdatedMessage">Η ημερομηνία ενημερώθηκε. Οι προσκλήσεις θα μπλοκαριστούν στις '+$('#datepicker').val()+'. Προσοχή! Όλες οι μη ολοκληρωμένες προσκλήσεις θα ακυρωθούν στις '+$('#datepicker').val()+'!</div>');
					}
            ...
            $(function() {
                ...
                <?php
                    ...
                    $rrr=mysql_fetch_object($rrr);
                ?>
                var date = '<?php if($rrr->calls_block_schedule!='0000-00-00'){ echo changeDate($rrr->calls_block_schedule); }elseif($rrr->calls_block){ echo date("d-m-Y");}?>';
