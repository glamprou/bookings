function UserManagement(opts)
{
	...
	var elements = {
		...
		grouppSelection:$('#grouppSelection'),
	...
	UserManagement.prototype.init = function ()
	{
		...
		elements.levelSelection.change(function ()
		{
			var statusid = $(this).val();
			if(statusid==0){
				window.location.href = options.groupsUrl;
			}
			else{
				window.location.href = options.filterUrl2 + statusid;
			}
		});
		
		elements.grouppSelection.change(function ()
		{
			var statusid = $(this).val();
			if(statusid==0){
				window.location.href = options.groupsUrl;
				...
				window.location.href = options.filterUrl3 + statusid;
			}
		});
