function AnnouncementManagement(opts) {
	...
	var editAnnouncement = function() {
		...
		if(announcement.important==1){
			elements.editImportant.prop('checked', true);
		}
		else{
			elements.editImportant.prop('checked', false);
		}
	...
	AnnouncementManagement.prototype.addAnnouncement = function(id, text, start, end, priority, important)
	{
		announcements[id] = {id: id, text: text, start: start, end: end, priority: priority, important: important};
	}
}