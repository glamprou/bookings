...
{
	public function __construct($text, Date $start, Date $end, $priority, $isimportant)
	{
		...
		$this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_IMPORTANT, $isimportant));
	}
}
...
class GetAllUsersByLevelCommand extends SqlCommand
{
	public function __construct($level)
	{
		parent::__construct(Queries::GET_ALL_USERS_BY_LEVEL);
		$this->AddParameter(new Parameter(ParameterNames::USER_LEVEL_ID, $level));
	}
}

class GetAllUsersByGroupCommand extends SqlCommand
{
	public function __construct($groupid)
	{
		parent::__construct(Queries::GET_ALL_USERS_BY_GROUP);
		$this->AddParameter(new Parameter(ParameterNames::USER_GROUP_ID, $groupid));
	}
}
...
{
	public function __construct($includeParticipants = false)
	{
        if(!$includeParticipants){
            ...
            parent::__construct(QueryBuilder::GET_RESERVATION_LIST_FULL_INC_PARTS());
        }
	}
}
...
{
	public function __construct($announcementId, $text, Date $start, Date $end, $priority, $important)
	{
		...
		$this->AddParameter(new Parameter(ParameterNames::END_DATE, $end->ToDatabase()));
		$this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_PRIORITY, $priority));
		$this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_IMPORTANT, $important));
	}
}
