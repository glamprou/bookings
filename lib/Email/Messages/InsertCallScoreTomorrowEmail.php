...
class InsertCallScoreTomorrowEmail extends EmailMessage
{
	/**
	 * @var User
	 */
	...
	function Subject()
	{
		return $this->Translate('InsertCallScore');
	}
	...
	function Body()
	{
		...
		return $this->FetchTemplate('InsertCallScoreTomorrowEmail.tpl');
	}
}
?>