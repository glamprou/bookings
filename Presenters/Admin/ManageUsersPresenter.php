	...
	public function PageLoad()
	{
		...
		else
		{
			if(isset($_GET['lvlsel'])){
				$userList = $this->userRepository->GetList2($this->page->GetPageNumber(), $this->page->GetPageSize(), null,
													   null, null, $this->page->GetFilterStatusId(),$_GET['lvlsel'],null);
			}
			else if(isset($_GET['grpsel'])){
				$userList = $this->userRepository->GetList2($this->page->GetPageNumber(), $this->page->GetPageSize(), null,
													   null, null, $this->page->GetFilterStatusId(),null,$_GET['grpsel']);
			}
			else{
