<?php /* Smarty version Smarty-3.1.7, created on 2014-09-21 08:31:12
         compiled from "/home/acetenni/public_html/bookings/lib/Common/../../tpl/Admin/manage_announcements.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1113531832541e7ec094c556-32510057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b62f9c01bf8c4fb9ff767e3993a9b8f10667c8e8' => 
    array (
      0 => '/home/acetenni/public_html/bookings/lib/Common/../../tpl/Admin/manage_announcements.tpl',
      1 => 1409936874,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1113531832541e7ec094c556-32510057',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_541e7ec2bdfda',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_541e7ec2bdfda')) {function content_541e7ec2bdfda($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/acetenni/public_html/bookings/lib/Common/../../lib/external/Smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_html_options')) include '/home/acetenni/public_html/bookings/lib/Common/../../lib/external/Smarty/plugins/function.html_options.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/home/acetenni/public_html/bookings/lib/Common/../../lib/external/Smarty/plugins/modifier.regex_replace.php';
...
<table class="list">
    ...
    <th><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Important_announc'),$_smarty_tpl);?>
</th>
...
"/></td>
		<td class="altop" style="width:300px;"><?php echo nl2br($_smarty_tpl->tpl_vars['announcement']->value->Text());?>
</td>
		<td class="altop"><?php echo $_smarty_tpl->tpl_vars['announcement']->value->Priority();?>
</td>
		<td class="altop" style="width: 100px;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formatdate'][0][0]->FormatDate(array('date'=>$_smarty_tpl->tpl_vars['announcement']->value->Start()->ToTimezone($_smarty_tpl->tpl_vars['timezone']->value)),$_smarty_tpl);?>
</td>
		<td class="altop" style="width: 100px;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formatdate'][0][0]->FormatDate(array('date'=>$_smarty_tpl->tpl_vars['announcement']->value->End()->ToTimezone($_smarty_tpl->tpl_vars['timezone']->value)),$_smarty_tpl);?>
</td>
        <td class="altop"><?php if ($_smarty_tpl->tpl_vars['announcement']->value->Important()==1){?>NAI<?php }else{ ?><?php }?></td>
		<td class="altop"><a href="#" class="update edit"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Edit'),$_smarty_tpl);?>
...
>
        ...
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Important_announc'),$_smarty_tpl);?>
 <br/>
        <input type="checkbox" id="editImportant"  <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'ANNOUNCEMENT_IMPORTANT'),$_smarty_tpl);?>
 />
    <br/>
...
',
				'<?php echo $_smarty_tpl->tpl_vars['announcement']->value->Important();?>
'
    );
	<?php } ?>
