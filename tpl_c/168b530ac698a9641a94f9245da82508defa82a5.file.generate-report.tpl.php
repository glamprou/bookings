<?php /* Smarty version Smarty-3.1.7, created on 2014-09-07 18:11:29
         compiled from "/home/acetenni/public_html/bookings/lib/Common/../../tpl/Reports/generate-report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1258613461540c91c1f3fdd3-66097030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '168b530ac698a9641a94f9245da82508defa82a5' => 
    array (
      0 => '/home/acetenni/public_html/bookings/lib/Common/../../tpl/Reports/generate-report.tpl',
      1 => 1409936895,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1258613461540c91c1f3fdd3-66097030',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_540c91c21a901',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_540c91c21a901')) {function content_540c91c21a901($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('globalheader.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('cssFiles'=>"css/reports.css,scripts/js/jqplot/jquery.jqplot.min.css"), 0);?>
...
"
                       id="results_training"/>
                <label for="results_training"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Trainings'),$_smarty_tpl);?>
</label>
			</div>
...
"
				...
				<label for="groupby_none"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'None2'),$_smarty_tpl);?>
</label>
				<input type="radio" <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'REPORT_GROUPBY'),$_smarty_tpl);?>
...
"
					   id="groupby_user"/>
                <label for="groupby_user" id="groupByUserLabel"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'User'),$_smarty_tpl);?>
 > <span id="zeroResUsersContainer"><input type="checkbox" id="zeroResUsers" name="zeroResUsers" />&nbsp; <label for="zeroResUsers">Μόνο χρήστες χωρίς κρατήσεις</label></span></label>
				<!--<input type="radio" <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'REPORT_GROUPBY'),$_smarty_tpl);?>
...
"
            ...
            <div class="input-set select-toggle" id="emptyDiv">
                <span class="label"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Usage'),$_smarty_tpl);?>
</span>
                <input type="hidden" id="training-search" name="training" value="true" disabled>
                <input type="radio" <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'REPORT_GROUPBY'),$_smarty_tpl);?>
 value="<?php echo Report_GroupBy::USER;?>
"
                       id="groupby_user_training"/>
                <label for="groupby_user_training" id="groupByUserLabel_training"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'User'),$_smarty_tpl);?>
...
/>
 ...
 />
			...
			<div class="input-set">
				...
				<select class="textbox" style="display:none" <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'RESOURCE_ID'),$_smarty_tpl);?>
>
...
<?php echo $_smarty_tpl->getSubTemplate ("Reports/chart.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
scripts/ajax-helpers.js"></script>
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
scripts/reports/generate-reports.js"></script>
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
scripts/reports/chart.js"></script>
