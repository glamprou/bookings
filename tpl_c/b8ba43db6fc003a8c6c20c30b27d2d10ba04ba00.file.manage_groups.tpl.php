<?php /* Smarty version Smarty-3.1.7, created on 2014-09-08 11:12:20
         compiled from "/home/acetenni/public_html/bookings/lib/Common/../../tpl/Admin/manage_groups.tpl" */ ?>
<?php /*%%SmartyHeaderCode:315224688540d81048c7b50-92000674%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b8ba43db6fc003a8c6c20c30b27d2d10ba04ba00' => 
    array (
      0 => '/home/acetenni/public_html/bookings/lib/Common/../../tpl/Admin/manage_groups.tpl',
      1 => 1409936876,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '315224688540d81048c7b50-92000674',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_540d8104b50a2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_540d8104b50a2')) {function content_540d8104b50a2($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/acetenni/public_html/bookings/lib/Common/../../lib/external/Smarty/plugins/function.cycle.php';
...
<table class="list">
	<tr>
		<th class="id">&nbsp;</th>
		<th style="text-align: left;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'GroupName'),$_smarty_tpl);?>
</th>
        ...
        <th><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'freeofcharge'),$_smarty_tpl);?>
</th>
        <th><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'coaches'),$_smarty_tpl);?>
</th>
        <th><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'guests'),$_smarty_tpl);?>
</th>
	</tr>
...
"/></td>
        ...
        <td align="center"><input type="checkbox" class="update-group-details" group-state-type="free_of_charge" group="<?php echo $_smarty_tpl->tpl_vars['group']->value->Id;?>
" <?php if (in_array($_smarty_tpl->tpl_vars['group']->value->Id,$_smarty_tpl->tpl_vars['freeGroups']->value)){?>checked="checked"<?php }?> name="foc_<?php echo $_smarty_tpl->tpl_vars['group']->value->Id;?>
" /></td>
        <td align="center"><input type="checkbox" class="update-group-details" group-state-type="coaches" group="<?php echo $_smarty_tpl->tpl_vars['group']->value->Id;?>
" <?php if (in_array($_smarty_tpl->tpl_vars['group']->value->Id,$_smarty_tpl->tpl_vars['coachesGroups']->value)){?>checked="checked"<?php }?> name="coaches_<?php echo $_smarty_tpl->tpl_vars['group']->value->Id;?>
" /></td>
        <td align="center"><input type="checkbox" class="update-group-details" group-state-type="guests" group="<?php echo $_smarty_tpl->tpl_vars['group']->value->Id;?>
" <?php if (in_array($_smarty_tpl->tpl_vars['group']->value->Id,$_smarty_tpl->tpl_vars['guestsGroups']->value)){?>checked="checked"<?php }?> name="guests_<?php echo $_smarty_tpl->tpl_vars['group']->value->Id;?>
" /></td>
	</tr>
<?php } ?>
</table>
...
?gid=',
	...
	$('.update-group-details ').change(function(){
        var $this = $(this);
		$.ajax({
			url: "../ajax/changeGroupDetails.php",
			type: "POST",
			data: {
                groupStateType: $this.attr('group-state-type'),
				id: $this.attr('group'),
