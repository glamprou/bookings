...
class Pages
{
    ...
    const RANKING = 'ranking.php';
    const CALLS = 'calls.php';
    const TOURNAMENTS = 'tours.php';
    const RANKING_ADMINISTRATION = 'rankingAdministration.php';
    const RANKING_VARIABLES = 'rankingVariables.php';
